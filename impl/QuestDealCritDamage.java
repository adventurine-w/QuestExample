...
public class QuestDealCritDamage extends QuestPredicateExtractor<LivingCustomMob> implements QuestTypeAbstr {
    @Override
    ...
    public double getProgress(Player subject, ChallengerLive live, ChallengerQuest quest, Event event) {
        if(event instanceof PlayerDamageCustomMobEvent ev && ev.getCrit()>0){
            return ev.getDamage();
        }return 0;
    }
}
